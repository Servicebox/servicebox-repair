    ...
    const calculatorSchema = {
        ...
        '@graph': [
            // === 1. WebApplication (сам калькулятор) ===
            {
                ...
                description: 'Бесплатный онлайн-калькулятор точной стоимости ремонта смартфонов, ноутбуков, планшетов, телевизоров, игровых приставок и видеокарт в СЕРВИС БОКС. Учитывает 300+ моделей устройств и 60+ видов работ. Цены ниже конкурентов на 500-2000₽.',
                ...
                mainEntity: [
                    {
                        ...
                        acceptedAnswer: {
                            '@type': 'Answer',
                            text: 'Замена дисплейного модуля iPhone 16 Pro Max в СЕРВИС БОКС стоит 8 990₽ (только работа). Это на 500-1500₽ дешевле конкурентов. Переклейка стекла — 11 000₽ (дешевле на 3000-5000₽). Замена занимает 30-60 минут, даём гарантию 12 месяцев.'
                        }
                    },
                    {
                        '@type': 'Question',
                        ...
                        acceptedAnswer: {
                            '@type': 'Answer',
                            text: 'В СЕРВИС БОКС замена разъёма Type-C стоит от 2500₽, Micro-USB — от 1800₽, Lightning — от 2800₽. Цены на 300-1000₽ ниже конкурентов. Работаем с iPhone, Samsung, Xiaomi, Huawei, Honor, Google Pixel, Realme и другими брендами.'
                        }
                    },
                    {
                        '@type': 'Question',
                        ...
                        acceptedAnswer: {
                            '@type': 'Answer',
                            text: 'Чистка ноутбука от пыли с заменой термопасты в СЕРВИС БОКС стоит от 2200₽ — это на 500-1500₽ дешевле конкурентов. Полная разборка системы охлаждения, замена термопасты (Thermal Grizzly / Arctic), проверка температур.'
                        }
                    },
                    {
                        '@type': 'Question',
            ...
            {
                '@type': 'HowTo',
                name: 'Как рассчитать стоимость ремонта в калькуляторе СЕРВИС БОКС',
