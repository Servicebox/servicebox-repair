...
export const PRICING = {
    phone: {
        ...
        services: {
            ...
            charging_micro_usb: { name: 'Замена разъёма Micro-USB', basePrice: 2200, minTime: '40 мин', maxTime: '2 часа', desc: 'Micro-USB порт (работа)', portType: 'micro_usb' },
            charging_30pin: { name: 'Замена разъёма 30-pin', basePrice: 2000, minTime: '40 мин', maxTime: '2 часа', desc: 'Старый Apple 30-pin', portType: '30pin' },
            charging_lightning: { name: 'Замена разъёма Lightning', basePrice: 3200, minTime: '40 мин', maxTime: '2 часа', desc: 'Apple Lightning порт (работа)', portType: 'lightning' },
            water: { name: 'Восстановление после воды', basePrice: 4500, minTime: '1 день', maxTime: '5 дней', desc: 'Ультразвуковая чистка платы' },
            camera: { name: 'Замена камеры', basePrice: 2800, minTime: '30 мин', maxTime: '1.5 часа', desc: 'Основная или фронтальная' },
            glass: { name: 'Переклейка стекла (OLED)', basePrice: 4500, minTime: '2 часа', maxTime: '4 часа', desc: 'Только для OLED/AMOLED. Замена стекла без дисплея', requiresSeparateGlass: true },
            speaker: { name: 'Ремонт динамика', basePrice: 1800, minTime: '30 мин', maxTime: '1 час', desc: 'Слуховой / полифонический' },
            ...
            face_id: { name: 'Ремонт Face ID / Touch ID', basePrice: 4500, minTime: '1 день', maxTime: '3 дня', desc: 'Восстановление биометрии', requiresFaceId: true },
        },
        brands: {
            apple: {
                multiplier: 1.3,
                name: 'Apple iPhone',
                models: [
                    { id: 'iphone_4', name: 'iPhone 4 / 4S', gen: 0.3, portType: '30pin', specificPrices: { battery: 1500, screen: 2000 } },
                    { id: 'iphone_5', name: 'iPhone 5 / 5S / 5C', gen: 0.35, portType: 'lightning', specificPrices: { battery: 1800, screen: 2500 } },
                    { id: 'iphone_6', name: 'iPhone 6 / 6 Plus', gen: 0.4, portType: 'lightning', specificPrices: { battery: 2000, screen: 3000 } },
                    { id: 'iphone_6s', name: 'iPhone 6S / 6S Plus', gen: 0.45, portType: 'lightning', specificPrices: { battery: 2200, screen: 3200 } },
                    { id: 'iphone_7_8', name: 'iPhone 7 / 8', gen: 0.5, portType: 'lightning', hasSeparateGlass: true, specificPrices: { battery: 2500, screen: 3500, glass: 4000 } },
                    { id: 'iphone_7_8_plus', name: 'iPhone 7 Plus / 8 Plus', gen: 0.5, portType: 'lightning', hasSeparateGlass: true, specificPrices: { battery: 2800, screen: 4000, glass: 4500 } },
                    { id: 'iphone_x_xs', name: 'iPhone X / XS', gen: 0.7, portType: 'lightning', hasSeparateGlass: true, specificPrices: { battery: 3000, screen: 4500, glass: 5500, face_id: 4500 } },
                    { id: 'iphone_xr', name: 'iPhone XR / 11', gen: 0.8, portType: 'lightning', specificPrices: { battery: 2500, screen: 4000, face_id: 4500 } },
                    { id: 'iphone_xs_max', name: 'iPhone XS Max', gen: 0.7, portType: 'lightning', hasSeparateGlass: true, specificPrices: { battery: 3500, screen: 5000, glass: 6500, face_id: 5000 } },
                    { id: 'iphone_11_pro', name: 'iPhone 11 Pro', gen: 0.85, portType: 'lightning', hasSeparateGlass: true, specificPrices: { battery: 3500, screen: 5500, glass: 7500, face_id: 5000 } },
                    { id: 'iphone_11_pro_max', name: 'iPhone 11 Pro Max', gen: 0.85, portType: 'lightning', hasSeparateGlass: true, specificPrices: { battery: 4000, screen: 6000, glass: 8500, face_id: 5500 } },
                    { id: 'iphone_se', name: 'iPhone SE (2020/2022)', gen: 0.6, portType: 'lightning', specificPrices: { battery: 2200, screen: 3500 } },
                    { id: 'iphone_12_mini', name: 'iPhone 12 Mini', gen: 0.95, portType: 'lightning', hasSeparateGlass: true, specificPrices: { battery: 3500, screen: 6000, glass: 8000, face_id: 5500 } },
                    { id: 'iphone_12', name: 'iPhone 12 / 12 Pro', gen: 0.95, portType: 'lightning', hasSeparateGlass: true, specificPrices: { battery: 4000, screen: 6500, glass: 9000, face_id: 6000 } },
                    { id: 'iphone_12_pro_max', name: 'iPhone 12 Pro Max', gen: 0.95, portType: 'lightning', hasSeparateGlass: true, specificPrices: { battery: 4500, screen: 7000, glass: 10000, face_id: 6000 } },
                    { id: 'iphone_13_mini', name: 'iPhone 13 Mini', gen: 1.0, portType: 'lightning', hasSeparateGlass: true, specificPrices: { battery: 3500, screen: 6500, glass: 7000, face_id: 6000 } },
                    { id: 'iphone_13', name: 'iPhone 13', gen: 1.0, portType: 'lightning', hasSeparateGlass: true, specificPrices: { battery: 4000, screen: 7000, glass: 8000, face_id: 6500 } },
                    { id: 'iphone_13_pro', name: 'iPhone 13 Pro', gen: 1.0, portType: 'lightning', hasSeparateGlass: true, specificPrices: { battery: 4500, screen: 8500, glass: 10000, face_id: 7000 } },
                    { id: 'iphone_13_pro_max', name: 'iPhone 13 Pro Max', gen: 1.0, portType: 'lightning', hasSeparateGlass: true, specificPrices: { battery: 5000, screen: 9500, glass: 12000, face_id: 7000 } },
                    { id: 'iphone_14', name: 'iPhone 14', gen: 1.1, portType: 'lightning', hasSeparateGlass: true, specificPrices: { battery: 4500, screen: 8000, glass: 9000, face_id: 7000 } },
                    { id: 'iphone_14_plus', name: 'iPhone 14 Plus', gen: 1.1, portType: 'lightning', hasSeparateGlass: true, specificPrices: { battery: 5000, screen: 9000, glass: 10000, face_id: 7500 } },
                    { id: 'iphone_14_pro', name: 'iPhone 14 Pro', gen: 1.1, portType: 'lightning', hasSeparateGlass: true, specificPrices: { battery: 5500, screen: 10500, glass: 12000, face_id: 8000 } },
                    { id: 'iphone_14_pro_max', name: 'iPhone 14 Pro Max', gen: 1.1, portType: 'lightning', hasSeparateGlass: true, specificPrices: { battery: 6000, screen: 12000, glass: 14000, face_id: 8000 } },
                    { id: 'iphone_15', name: 'iPhone 15 / 15 Plus', gen: 1.2, portType: 'type_c', hasSeparateGlass: true, specificPrices: { battery: 5000, screen: 9000, glass: 11000, face_id: 8000 } },
                    { id: 'iphone_15_pro', name: 'iPhone 15 Pro', gen: 1.5, portType: 'type_c', hasSeparateGlass: true, specificPrices: { battery: 6500, screen: 12000, glass: 14000, face_id: 9000 } },
                    { id: 'iphone_15_pro_max', name: 'iPhone 15 Pro Max', gen: 1.5, portType: 'type_c', hasSeparateGlass: true, specificPrices: { battery: 7000, screen: 14000, glass: 16000, face_id: 9500 } },
                    { id: 'iphone_16', name: 'iPhone 16 / 16 Plus', gen: 1.4, portType: 'type_c', hasSeparateGlass: true, specificPrices: { battery: 5500, screen: 10000, glass: 12000, face_id: 9000 } },
                    { id: 'iphone_16_pro', name: 'iPhone 16 Pro', gen: 1.7, portType: 'type_c', hasSeparateGlass: true, specificPrices: { battery: 7500, screen: 14000, glass: 16000, face_id: 10000 } },
                    { id: 'iphone_16_pro_max', name: 'iPhone 16 Pro Max', gen: 1.7, portType: 'type_c', hasSeparateGlass: true, specificPrices: { battery: 8500, screen: 16000, glass: 19000, face_id: 10500 } },
                    { id: 'iphone_17', name: 'iPhone 17 / 17 Plus', gen: 1.8, portType: 'type_c', hasSeparateGlass: true, specificPrices: { battery: 6500, screen: 12000, glass: 14000, face_id: 10000 } },
                    { id: 'iphone_17_air', name: 'iPhone 17 Air (тонкий)', gen: 2.0, portType: 'type_c', hasSeparateGlass: true, specificPrices: { battery: 7500, screen: 14000, glass: 16000, face_id: 11000 } },
                    { id: 'iphone_17_pro', name: 'iPhone 17 Pro', gen: 2.2, portType: 'type_c', hasSeparateGlass: true, specificPrices: { battery: 9500, screen: 17000, glass: 18000, face_id: 12000 } },
                    { id: 'iphone_17_pro_max', name: 'iPhone 17 Pro Max', gen: 2.3, portType: 'type_c', hasSeparateGlass: true, specificPrices: { battery: 10500, screen: 20000, glass: 22000, face_id: 13000 } },
                ]
            },
            samsung: {
                multiplier: 1.1,
                name: 'Samsung Galaxy',
                models: [
                    { id: 'galaxy_s2_s4', name: 'Galaxy S2 / S3 / S4', gen: 0.3, portType: 'micro_usb', specificPrices: { battery: 1500, screen: 2500 } },
                    { id: 'galaxy_s5_s7', name: 'Galaxy S5 / S6 / S7', gen: 0.5, portType: 'micro_usb', hasSeparateGlass: true, specificPrices: { battery: 2200, screen: 3500, glass: 3500 } },
                    { id: 'galaxy_a_old_micro', name: 'Galaxy A3/A5/A7 (2016-2017)', gen: 0.5, portType: 'micro_usb', specificPrices: { battery: 2000, screen: 2800 } },
                    { id: 'galaxy_j', name: 'Galaxy J3/J5/J7 (2016-2018)', gen: 0.5, portType: 'micro_usb', specificPrices: { battery: 2000, screen: 2800 } },
                    { id: 'galaxy_note_old', name: 'Galaxy Note 3/4/5', gen: 0.5, portType: 'micro_usb', specificPrices: { battery: 2200, screen: 3500 } },
                    { id: 'galaxy_s_old', name: 'Galaxy S8/S9/S10/S20', gen: 0.7, portType: 'type_c', hasSeparateGlass: true, specificPrices: { battery: 3000, screen: 4500, glass: 4500 } },
                    { id: 'galaxy_a_old', name: 'Galaxy A10/A20/A30/A40', gen: 0.6, portType: 'type_c', specificPrices: { battery: 2500, screen: 3500 } },
                    { id: 'galaxy_a_mid', name: 'Galaxy A51/A52/A53/A54', gen: 0.8, portType: 'type_c', specificPrices: { battery: 3000, screen: 4000 } },
                    { id: 'galaxy_note_mid', name: 'Galaxy Note 8/9/10', gen: 0.7, portType: 'type_c', hasSeparateGlass: true, specificPrices: { battery: 3200, screen: 5000, glass: 5000 } },
                    { id: 'galaxy_s21', name: 'Galaxy S21/S21+/S21 Ultra', gen: 0.9, portType: 'type_c', hasSeparateGlass: true, specificPrices: { battery: 4000, screen: 5000, glass: 5500 } },
                    { id: 'galaxy_s22', name: 'Galaxy S22/S22+/S22 Ultra', gen: 1.0, portType: 'type_c', hasSeparateGlass: true, specificPrices: { battery: 4500, screen: 5500, glass: 6000 } },
                    { id: 'galaxy_s23', name: 'Galaxy S23/S23+/S23 Ultra', gen: 1.15, portType: 'type_c', hasSeparateGlass: true, specificPrices: { battery: 5000, screen: 6500, glass: 7000 } },
                    { id: 'galaxy_s24', name: 'Galaxy S24/S24+/S24 Ultra', gen: 1.3, portType: 'type_c', hasSeparateGlass: true, specificPrices: { battery: 5500, screen: 8000, glass: 8500 } },
                    { id: 'galaxy_a_new', name: 'Galaxy A55/A56', gen: 0.95, portType: 'type_c', specificPrices: { battery: 3500, screen: 4500 } },
                    { id: 'galaxy_s25', name: 'Galaxy S25 / S25+', gen: 1.5, portType: 'type_c', hasSeparateGlass: true, specificPrices: { battery: 6000, screen: 9500, glass: 6500 } },
                    { id: 'galaxy_s25_ultra', name: 'Galaxy S25 Ultra', gen: 1.8, portType: 'type_c', hasSeparateGlass: true, specificPrices: { battery: 7000, screen: 12000, glass: 9000 } },
                    { id: 'galaxy_s25_fe', name: 'Galaxy S25 FE', gen: 1.3, portType: 'type_c', hasSeparateGlass: true, specificPrices: { battery: 5000, screen: 7500 } },
                    { id: 'galaxy_flip', name: 'Galaxy Z Flip 3/4/5/6', gen: 1.4, portType: 'type_c', hasSeparateGlass: true, specificPrices: { battery: 5000, screen: 9000, glass: 6000 } },
                    { id: 'galaxy_flip7', name: 'Galaxy Z Flip 7', gen: 1.7, portType: 'type_c', hasSeparateGlass: true, specificPrices: { battery: 6000, screen: 11000, glass: 8000 } },
                    { id: 'galaxy_fold', name: 'Galaxy Z Fold 3/4/5/6', gen: 1.7, portType: 'type_c', hasSeparateGlass: true, specificPrices: { battery: 6500, screen: 16000, glass: 11000 } },
                    { id: 'galaxy_fold7', name: 'Galaxy Z Fold 7', gen: 2.0, portType: 'type_c', hasSeparateGlass: true, specificPrices: { battery: 7500, screen: 20000, glass: 14000 } },
                ]
            },
            xiaomi: {
                multiplier: 0.9,
                ...
                models: [
                    { id: 'redmi_old_micro', name: 'Redmi 3/4/5/6/7/8', gen: 0.5, portType: 'micro_usb', specificPrices: { battery: 1800, screen: 2500 } },
                    { id: 'redmi_note_old_micro', name: 'Redmi Note 4/5/6/7/8', gen: 0.5, portType: 'micro_usb', specificPrices: { battery: 2000, screen: 2800 } },
                    { id: 'mi_old', name: 'Mi 5/6/8/9', gen: 0.6, portType: 'type_c', specificPrices: { battery: 2200, screen: 3200 } },
                    { id: 'redmi_note_mid', name: 'Redmi Note 9/10/11/12', gen: 0.8, portType: 'type_c', specificPrices: { battery: 2500, screen: 3500 } },
                    { id: 'poco_x', name: 'POCO X3/X4/X5/X6/F3/F4/F5', gen: 0.9, portType: 'type_c', specificPrices: { battery: 2800, screen: 3800 } },
                    { id: 'xiaomi_flagship', name: 'Xiaomi 11/12/13/14', gen: 1.2, portType: 'type_c', hasSeparateGlass: true, specificPrices: { battery: 4000, screen: 6000, glass: 5000 } },
                    { id: 'redmi_note_new', name: 'Redmi Note 13/13 Pro', gen: 1.0, portType: 'type_c', specificPrices: { battery: 3000, screen: 4000 } },
                    { id: 'redmi_note14', name: 'Redmi Note 14 / 14 Pro', gen: 1.1, portType: 'type_c', specificPrices: { battery: 3200, screen: 4200 } },
                    { id: 'redmi_note14_pro_plus', name: 'Redmi Note 14 Pro+', gen: 1.2, portType: 'type_c', hasSeparateGlass: true, specificPrices: { battery: 3500, screen: 5000, glass: 4500 } },
                    { id: 'xiaomi_15', name: 'Xiaomi 15', gen: 1.5, portType: 'type_c', hasSeparateGlass: true, specificPrices: { battery: 4500, screen: 7500, glass: 5000 } },
                    { id: 'xiaomi_15_pro', name: 'Xiaomi 15 Pro', gen: 1.7, portType: 'type_c', hasSeparateGlass: true, specificPrices: { battery: 5000, screen: 9000, glass: 6500 } },
                    { id: 'xiaomi_15_ultra', name: 'Xiaomi 15 Ultra', gen: 2.0, portType: 'type_c', hasSeparateGlass: true, specificPrices: { battery: 6000, screen: 11000, glass: 8500 } },
                    { id: 'xiaomi_14t', name: 'Xiaomi 14T / 14T Pro', gen: 1.3, portType: 'type_c', hasSeparateGlass: true, specificPrices: { battery: 4000, screen: 6500, glass: 5500 } },
                    { id: 'poco_f7', name: 'POCO F7 / F7 Pro', gen: 1.2, portType: 'type_c', hasSeparateGlass: true, specificPrices: { battery: 3800, screen: 5800, glass: 5000 } },
                    { id: 'poco_x7', name: 'POCO X7 / X7 Pro', gen: 1.0, portType: 'type_c', specificPrices: { battery: 3000, screen: 4000 } },
                ]
            },
            huawei: {
                multiplier: 1.0,
                name: 'Huawei / Honor',
                models: [
                    { id: 'huawei_p_old_micro', name: 'Huawei P8/P9/P10/P20 Lite', gen: 0.6, portType: 'micro_usb', specificPrices: { battery: 2200, screen: 3200 } },
                    { id: 'honor_old_micro', name: 'Honor 6/7/8/9/10 Lite', gen: 0.6, portType: 'micro_usb', specificPrices: { battery: 2200, screen: 3200 } },
                    { id: 'honor_mid', name: 'Honor 50/60/70/80/90', gen: 0.9, portType: 'type_c', specificPrices: { battery: 3000, screen: 4000 } },
                    { id: 'huawei_p_new', name: 'Huawei P30/P40/P50/P60 Pro', gen: 1.1, portType: 'type_c', hasSeparateGlass: true, specificPrices: { battery: 3500, screen: 5000, glass: 5500 } },
                    { id: 'honor_magic', name: 'Honor Magic 5 / 6 Pro', gen: 1.3, portType: 'type_c', hasSeparateGlass: true, specificPrices: { battery: 4000, screen: 6000, glass: 6500 } },
                    { id: 'honor_200', name: 'Honor 200 / 200 Pro', gen: 1.4, portType: 'type_c', hasSeparateGlass: true, specificPrices: { battery: 4000, screen: 7000, glass: 6500 } },
                    { id: 'honor_magic7', name: 'Honor Magic 7 / 7 Pro', gen: 1.6, portType: 'type_c', hasSeparateGlass: true, specificPrices: { battery: 4500, screen: 9000, glass: 8000 } },
                    { id: 'huawei_p70', name: 'Huawei P70 / P70 Pro', gen: 1.5, portType: 'type_c', hasSeparateGlass: true, specificPrices: { battery: 4000, screen: 8000, glass: 7500 } },
                    { id: 'huawei_mate60', name: 'Huawei Mate 60 / 60 Pro', gen: 1.6, portType: 'type_c', hasSeparateGlass: true, specificPrices: { battery: 4500, screen: 9500, glass: 8500 } },
                ]
            },
            other: {
                multiplier: 1.0,
                ...
                models: [
                    { id: 'other_old', name: 'Старая модель (Micro-USB)', gen: 0.6, portType: 'micro_usb', specificPrices: { battery: 2200, screen: 3000 } },
                    { id: 'other_mid', name: 'Средняя модель (IPS)', gen: 0.9, portType: 'type_c', specificPrices: { battery: 3000, screen: 3800 } },
                    { id: 'other_new', name: 'Новая модель (OLED)', gen: 1.1, portType: 'type_c', hasSeparateGlass: true, specificPrices: { battery: 3500, screen: 4500, glass: 5000 } },
                ]
            },
        },
    },
    ...
    tablet: {
        ...
        brands: {
            apple: {
                ...
                name: 'Apple iPad',
                models: [
                    { id: 'ipad_old', name: 'iPad 7/8/9/10 (2019-2022)', gen: 0.8, portType: 'lightning', specificPrices: { battery: 3500, screen: 4500, glass: 3500 } },
                    { id: 'ipad_air', name: 'iPad Air 4 / 5 (2020-2022)', gen: 1.0, portType: 'type_c', specificPrices: { battery: 4000, screen: 5500, glass: 4500 } },
                    { id: 'ipad_pro_11', name: 'iPad Pro 11" (2020-2024)', gen: 1.2, portType: 'type_c', specificPrices: { battery: 5000, screen: 7000, glass: 6000 } },
                    { id: 'ipad_pro_12', name: 'iPad Pro 12.9" / 13" (2020-2024)', gen: 1.4, portType: 'type_c', specificPrices: { battery: 6500, screen: 10000, glass: 8000 } },
                    { id: 'ipad_mini', name: 'iPad mini 6 / mini 7 (2021-2024)', gen: 1.0, portType: 'type_c', specificPrices: { battery: 3500, screen: 5500, glass: 4500 } },
                    { id: 'ipad_air_m3', name: 'iPad Air M3 (2025)', gen: 1.3, portType: 'type_c', specificPrices: { battery: 4500, screen: 8000, glass: 6500 } },
                    { id: 'ipad_pro_m4', name: 'iPad Pro M4 11"/13" (2024-2025)', gen: 1.6, portType: 'type_c', specificPrices: { battery: 7000, screen: 12000, glass: 9000 } },
                ]
            },
            samsung: {
                multiplier: 1.1,
                ...
                models: [
                    { id: 'tab_a_old', name: 'Galaxy Tab A 10.1 (2019)', gen: 0.7, portType: 'micro_usb', specificPrices: { battery: 2800, screen: 3800, glass: 3000 } },
                    { id: 'tab_a', name: 'Galaxy Tab A7/A8/A9 (2020-2024)', gen: 0.7, portType: 'type_c', specificPrices: { battery: 2800, screen: 3800, glass: 3000 } },
                    { id: 'tab_s7', name: 'Galaxy Tab S7 / S7+ (2020)', gen: 0.9, portType: 'type_c', specificPrices: { battery: 3500, screen: 5000, glass: 4500 } },
                    { id: 'tab_s8', name: 'Galaxy Tab S8 / S8+ / S8 Ultra (2022)', gen: 1.1, portType: 'type_c', specificPrices: { battery: 4000, screen: 6000, glass: 5500 } },
                    { id: 'tab_s9', name: 'Galaxy Tab S9 / S9+ / S9 Ultra (2023)', gen: 1.3, portType: 'type_c', specificPrices: { battery: 4500, screen: 7000, glass: 6500 } },
                    { id: 'tab_s10', name: 'Galaxy Tab S10 / S10+ / S10 Ultra (2024)', gen: 1.5, portType: 'type_c', specificPrices: { battery: 5000, screen: 8000, glass: 7500 } },
                ]
            },
            xiaomi: {
                multiplier: 0.9,
                name: 'Xiaomi Pad',
                models: [
                    { id: 'xiaomi_pad', name: 'Xiaomi Pad 5/6', gen: 0.9, portType: 'type_c', specificPrices: { battery: 3000, screen: 4000, glass: 3500 } },
                    { id: 'xiaomi_pad_pro', name: 'Xiaomi Pad 6 Pro / S Pro', gen: 1.1, portType: 'type_c', specificPrices: { battery: 3500, screen: 5000, glass: 4500 } },
                    { id: 'redmi_pad', name: 'Redmi Pad / Redmi Pad SE', gen: 0.8, portType: 'type_c', specificPrices: { battery: 2800, screen: 3500, glass: 3000 } },
                    { id: 'xiaomi_pad_7', name: 'Xiaomi Pad 7 / 7 Pro (2024-2025)', gen: 1.2, portType: 'type_c', specificPrices: { battery: 3800, screen: 5500, glass: 5000 } },
                    { id: 'redmi_pad_pro', name: 'Redmi Pad Pro (2024)', gen: 1.0, portType: 'type_c', specificPrices: { battery: 3200, screen: 4200, glass: 3500 } },
                ]
            },
            huawei: {
                multiplier: 1.0,
                name: 'Huawei MatePad',
                models: [
                    { id: 'matepad_old', name: 'MatePad 11 / 11.5 (2021-2022)', gen: 0.9, portType: 'type_c', specificPrices: { battery: 3200, screen: 4200, glass: 3500 } },
                    { id: 'matepad_pro', name: 'MatePad Pro 12.6 (2021-2023)', gen: 1.2, portType: 'type_c', specificPrices: { battery: 4500, screen: 6000, glass: 5500 } },
                    { id: 'matepad_t', name: 'MatePad T10 / T10s', gen: 0.7, portType: 'micro_usb', specificPrices: { battery: 2800, screen: 3500, glass: 3000 } },
                    { id: 'matepad_2024', name: 'MatePad 11.5" S / Pro (2024)', gen: 1.3, portType: 'type_c', specificPrices: { battery: 4000, screen: 5500, glass: 5000 } },
                    { id: 'matepad_air', name: 'MatePad Air (2024-2025)', gen: 1.2, portType: 'type_c', specificPrices: { battery: 3800, screen: 5000, glass: 4500 } },
                ]
            },
            lenovo: {
                multiplier: 1.0,
                name: 'Lenovo Tab',
                models: [
                    { id: 'lenovo_m_old', name: 'Lenovo Tab M10 (2019)', gen: 0.8, portType: 'micro_usb', specificPrices: { battery: 2800, screen: 3500, glass: 3000 } },
                    { id: 'lenovo_m', name: 'Lenovo Tab M10/M11 (2022-2024)', gen: 0.8, portType: 'type_c', specificPrices: { battery: 2800, screen: 3500, glass: 3000 } },
                    { id: 'lenovo_p', name: 'Lenovo Tab P11 / P12', gen: 1.0, portType: 'type_c', specificPrices: { battery: 3500, screen: 4500, glass: 4000 } },
                    { id: 'lenovo_extreme', name: 'Lenovo Tab Extreme', gen: 1.3, portType: 'type_c', specificPrices: { battery: 5000, screen: 7000, glass: 6500 } },
                    { id: 'lenovo_p12_2025', name: 'Lenovo Tab P12 / P12 Pro (2024-2025)', gen: 1.2, portType: 'type_c', specificPrices: { battery: 4500, screen: 6000, glass: 5500 } },
                    { id: 'lenovo_yoga_tab', name: 'Yoga Tab 11/13 (2024-2025)', gen: 1.1, portType: 'type_c', specificPrices: { battery: 4000, screen: 5500, glass: 5000 } },
                ]
            },
            other: {
                multiplier: 1.0,
                name: 'Другой бренд',
                models: [
                    { id: 'tablet_budget', name: 'Бюджетный планшет', gen: 0.7, portType: 'micro_usb', specificPrices: { battery: 2500, screen: 3200, glass: 2800 } },
                    { id: 'tablet_mid', name: 'Средний класс', gen: 0.9, portType: 'type_c', specificPrices: { battery: 3200, screen: 4000, glass: 3500 } },
                    { id: 'tablet_premium', name: 'Премиум', gen: 1.2, portType: 'type_c', specificPrices: { battery: 4500, screen: 5500, glass: 5000 } },
                ]
            },
        },
    },
    ...
    tv: {
        ...
        brands: {
            samsung: {
                ...
                name: 'Samsung',
                models: [
                    // ✅ ИСПРАВЛЕНО: было "43-55"", стало "32-55"" (есть модели 32")
                    { id: 'samsung_uhd', name: 'Crystal UHD 32-55"', gen: 0.9, tvType: 'led', specificPrices: { backlight_small: 5500, backlight_medium: 8500 } },
                    { id: 'samsung_uhd_large', name: 'Crystal UHD 58-75"', gen: 1.1, tvType: 'led', specificPrices: { backlight_large: 11500, backlight_xlarge: 18000 } },
                    { id: 'samsung_qled', name: 'QLED 43-65"', gen: 1.2, tvType: 'qled', specificPrices: { backlight_qled: 16000 } },
                    { id: 'samsung_neo_qled', name: 'Neo QLED 55-75"', gen: 1.4, tvType: 'mini_led', specificPrices: { backlight_qled: 19000 } },
                    { id: 'samsung_frame', name: 'The Frame 32-55"', gen: 1.3, tvType: 'led', specificPrices: { backlight_small: 6000, backlight_medium: 8500 } },
                    { id: 'samsung_oled', name: 'OLED 55-65" (2024-2025)', gen: 1.5, tvType: 'oled', specificPrices: { backlight_oled: 26000 } },
                ]
            },
            lg: {
                multiplier: 1.2,
                name: 'LG',
                models: [
                    // ✅ ИСПРАВЛЕНО: было "43-55"", стало "32-55""
                    { id: 'lg_uhd', name: 'UHD 32-55"', gen: 0.9, tvType: 'led', specificPrices: { backlight_small: 5500, backlight_medium: 8500 } },
                    { id: 'lg_uhd_large', name: 'UHD 58-75"', gen: 1.1, tvType: 'led', specificPrices: { backlight_large: 11500, backlight_xlarge: 18000 } },
                    { id: 'lg_nanocell', name: 'NanoCell 43-65"', gen: 1.1, tvType: 'led', specificPrices: { backlight_small: 5500, backlight_medium: 9500, backlight_large: 12500 } },
                    { id: 'lg_oled', name: 'OLED 48-65"', gen: 1.4, tvType: 'oled', specificPrices: { backlight_oled: 27000 } },
                    { id: 'lg_oled_large', name: 'OLED 65-83"', gen: 1.6, tvType: 'oled', specificPrices: { backlight_oled: 35000 } },
                    { id: 'lg_qned', name: 'QNED 55-75"', gen: 1.3, tvType: 'qled', specificPrices: { backlight_medium: 8500, backlight_large: 11000 } },
                    { id: 'lg_oled_evo', name: 'OLED evo 55-77" (2024-2025)', gen: 1.5, tvType: 'oled', specificPrices: { backlight_oled: 30000 } },
                ]
            },
            sony: {
                multiplier: 1.3,
                name: 'Sony',
                models: [
                    // ✅ ИСПРАВЛЕНО: Sony X75/X80 бывают только 43-55", убран backlight_small
                    { id: 'sony_x75', name: 'Bravia X75/X80 43-55"', gen: 0.9, tvType: 'led', specificPrices: { backlight_medium: 9500 } },
                    { id: 'sony_x85', name: 'Bravia X85/X90 55-75"', gen: 1.1, tvType: 'led', specificPrices: { backlight_medium: 11000, backlight_large: 15000 } },
                    { id: 'sony_oled', name: 'Bravia XR A80/A90 OLED', gen: 1.4, tvType: 'oled', specificPrices: { backlight_oled: 30000 } },
                    { id: 'sony_x95', name: 'Bravia XR X95/X98 55-85"', gen: 1.3, tvType: 'led', specificPrices: { backlight_large: 13000, backlight_xlarge: 18000 } },
                    { id: 'sony_bravia_9', name: 'Bravia 9 Mini-LED (2024-2025)', gen: 1.5, tvType: 'mini_led', specificPrices: { backlight_qled: 20000 } },
                ]
            },
            philips: {
                multiplier: 1.1,
                ...
                models: [
                    // ✅ ИСПРАВЛЕНО: было "43-55"", стало "32-55""
                    { id: 'philips_performance', name: 'Performance 32-55"', gen: 0.9, tvType: 'led', specificPrices: { backlight_small: 5800, backlight_medium: 8500 } },
                    { id: 'philips_pus', name: 'PUS 58-75"', gen: 1.0, tvType: 'led', specificPrices: { backlight_large: 11500, backlight_xlarge: 18000 } },
                    { id: 'philips_oled', name: 'OLED 55-65"', gen: 1.4, tvType: 'oled', specificPrices: { backlight_oled: 26000 } },
                    { id: 'philips_oled_2025', name: 'OLED 2025 (Ambilight)', gen: 1.5, tvType: 'oled', specificPrices: { backlight_oled: 28000 } },
                ]
            },
            tcl: {
                multiplier: 1.0,
                ...
                models: [
                    // ✅ ИСПРАВЛЕНО: было "43-55"", стало "32-55""
                    { id: 'tcl_p', name: 'P-series 32-55"', gen: 0.8, tvType: 'led', specificPrices: { backlight_small: 5000, backlight_medium: 7500 } },
                    { id: 'tcl_c', name: 'C-series 55-75"', gen: 1.0, tvType: 'led', specificPrices: { backlight_medium: 8500, backlight_large: 11500 } },
                    { id: 'tcl_qled', name: 'QLED 55-65"', gen: 1.1, tvType: 'qled', specificPrices: { backlight_qled: 14500 } },
                    { id: 'tcl_mini_led', name: 'Mini-LED QM8 (2024-2025)', gen: 1.3, tvType: 'mini_led', specificPrices: { backlight_qled: 16000 } },
                ]
            },
            xiaomi: {
                multiplier: 0.9,
                name: 'Xiaomi',
                models: [
                    { id: 'xiaomi_a2', name: 'TV A2 32-43"', gen: 0.8, tvType: 'led', specificPrices: { backlight_small: 4800 } },
                    { id: 'xiaomi_q1', name: 'TV Q1 55-75"', gen: 1.0, tvType: 'led', specificPrices: { backlight_medium: 8000, backlight_large: 11000 } },
                    // ✅ ИСПРАВЛЕНО: было "43-55"", стало "32-55""
                    { id: 'xiaomi_p1', name: 'TV P1 32-55"', gen: 0.9, tvType: 'led', specificPrices: { backlight_small: 5200, backlight_medium: 8000 } },
                    { id: 'xiaomi_s_pro', name: 'TV S Pro Mini-LED (2024-2025)', gen: 1.2, tvType: 'mini_led', specificPrices: { backlight_qled: 15000 } },
                ]
            },
            hisense: {
                multiplier: 1.0,
                ...
                models: [
                    // ✅ ИСПРАВЛЕНО: было "43-55"", стало "32-55""
                    { id: 'hisense_a_series', name: 'A4/A6 Series 32-55"', gen: 0.8, tvType: 'led', specificPrices: { backlight_small: 5000, backlight_medium: 7500 } },
                    { id: 'hisense_u_series', name: 'U6/U7/U8 (ULED) 55-75"', gen: 1.1, tvType: 'qled', specificPrices: { backlight_qled: 14000 } },
                    { id: 'hisense_oled', name: 'OLED 55-65"', gen: 1.3, tvType: 'oled', specificPrices: { backlight_oled: 24000 } },
                ]
            },
            other: {
                multiplier: 1.0,
                name: 'Другой бренд',
                models: [
                    { id: 'tv_small', name: 'LED 32-43 дюйма', gen: 0.8, tvType: 'led', specificPrices: { backlight_small: 5500 } },
                    { id: 'tv_medium', name: 'LED 49-55 дюймов', gen: 1.0, tvType: 'led', specificPrices: { backlight_medium: 8000 } },
                    { id: 'tv_large', name: 'LED 58-75 дюймов', gen: 1.2, tvType: 'led', specificPrices: { backlight_large: 11500, backlight_xlarge: 17500 } },
                    { id: 'tv_qled', name: 'QLED телевизор', gen: 1.3, tvType: 'qled', specificPrices: { backlight_qled: 15000 } },
                    { id: 'tv_oled', name: 'OLED телевизор', gen: 1.4, tvType: 'oled', specificPrices: { backlight_oled: 24000 } },
                ]
            },
        },
    },
    ...
    console: {
        ...
        brands: {
            playstation: {
                ...
                name: 'PlayStation',
                models: [
                    { id: 'ps3', name: 'PlayStation 3 (Fat/Slim/Super Slim)', gen: 0.7, specificPrices: { cleaning: 2000, thermal: 2500, hdmi: 3800, drive: 3200, power: 3500, motherboard: 6000, reball_apu: 7000, replace_apu: 10000 } },
                    { id: 'ps4_slim', name: 'PlayStation 4 Slim', gen: 0.9, specificPrices: { cleaning: 2500, thermal: 2800, hdmi: 4200, drive: 3800, power: 4000, motherboard: 7000, reball_apu: 8000, replace_apu: 11000 } },
                    { id: 'ps4_pro', name: 'PlayStation 4 Pro', gen: 1.0, specificPrices: { cleaning: 2800, thermal: 3200, hdmi: 4800, drive: 4200, power: 4500, motherboard: 8000, reball_apu: 9000, replace_apu: 12000 } },
                    { id: 'ps5_standard', name: 'PlayStation 5 Standard', gen: 1.2, specificPrices: { cleaning: 4200, thermal: 3800, hdmi: 6500, controller: 3500, drive: 6500, power: 5800, motherboard: 11000, liquid_metal: 6500, ssd_upgrade: 3200, reball_apu: 12000, replace_apu: 16000 } },
                    { id: 'ps5_digital', name: 'PlayStation 5 Digital Edition', gen: 1.2, specificPrices: { cleaning: 4200, thermal: 3800, hdmi: 6500, controller: 3500, power: 5800, motherboard: 11000, liquid_metal: 6500, ssd_upgrade: 3200, reball_apu: 12000, replace_apu: 16000 } },
                    { id: 'ps5_slim', name: 'PlayStation 5 Slim / Slim Digital', gen: 1.3, specificPrices: { cleaning: 4800, thermal: 4200, hdmi: 7200, controller: 3800, drive: 7000, power: 6200, motherboard: 12000, liquid_metal: 7000, ssd_upgrade: 3200, reball_apu: 13000, replace_apu: 17000 } },
                    { id: 'ps5_pro', name: 'PlayStation 5 Pro (2024)', gen: 1.5, specificPrices: { cleaning: 5500, thermal: 4800, hdmi: 8000, controller: 4200, drive: 8000, power: 7000, motherboard: 14000, liquid_metal: 7500, ssd_upgrade: 3500, reball_apu: 15000, replace_apu: 20000 } },
                ]
            },
            xbox: {
                multiplier: 1.1,
                name: 'Xbox',
                models: [
                    { id: 'xbox_one_s', name: 'Xbox One S', gen: 0.8, specificPrices: { cleaning: 2200, thermal: 2800, hdmi: 4200, drive: 3800, power: 4000, motherboard: 7000, reball_apu: 8000, replace_apu: 11000 } },
                    { id: 'xbox_one_x', name: 'Xbox One X', gen: 0.9, specificPrices: { cleaning: 2500, thermal: 3200, hdmi: 4800, drive: 4200, power: 4500, motherboard: 8000, reball_apu: 9000, replace_apu: 12000 } },
                    { id: 'xbox_series_s', name: 'Xbox Series S', gen: 1.1, specificPrices: { cleaning: 3200, thermal: 3500, hdmi: 5500, power: 5000, ssd_upgrade: 3500, motherboard: 9000, reball_apu: 10000, replace_apu: 14000 } },
                    { id: 'xbox_series_x', name: 'Xbox Series X', gen: 1.3, specificPrices: { cleaning: 3800, thermal: 4000, hdmi: 6500, drive: 6000, power: 5800, ssd_upgrade: 3800, motherboard: 10500, liquid_metal: 6000, reball_apu: 12000, replace_apu: 16000 } },
                    { id: 'xbox_series_x_digital', name: 'Xbox Series X Digital Edition', gen: 1.3, specificPrices: { cleaning: 3800, thermal: 4000, hdmi: 6500, power: 5800, ssd_upgrade: 3800, motherboard: 10500, liquid_metal: 6000, reball_apu: 12000, replace_apu: 16000 } },
                ]
            },
            nintendo: {
                multiplier: 1.0,
                ...
                models: [
                    { id: 'switch', name: 'Nintendo Switch (2017-2019)', gen: 0.9, specificPrices: { cleaning: 2000, thermal: 2200, controller: 2800, power: 3200, motherboard: 6500, reball_apu: 7500, replace_apu: 10000 } },
                    { id: 'switch_v2', name: 'Nintendo Switch V2 (2019+)', gen: 1.0, specificPrices: { cleaning: 2200, thermal: 2500, controller: 2800, power: 3500, motherboard: 7000, reball_apu: 8000, replace_apu: 11000 } },
                    { id: 'switch_lite', name: 'Nintendo Switch Lite', gen: 1.0, specificPrices: { cleaning: 2000, thermal: 2200, power: 3200, motherboard: 6000, reball_apu: 7000, replace_apu: 9500 } },
                    { id: 'switch_oled', name: 'Nintendo Switch OLED', gen: 1.2, specificPrices: { cleaning: 2500, thermal: 2800, controller: 3200, power: 3800, motherboard: 8000, reball_apu: 9000, replace_apu: 12000 } },
                    { id: 'switch_2', name: 'Nintendo Switch 2 (2025)', gen: 1.5, specificPrices: { cleaning: 3200, thermal: 3500, controller: 4000, power: 4500, motherboard: 9000, reball_apu: 10000, replace_apu: 14000 } },
                ]
            },
            steam_deck: {
                multiplier: 1.2,
                name: 'Steam Deck',
                models: [
                    { id: 'steam_deck_lcd', name: 'Steam Deck LCD 64/256/512GB', gen: 1.0, specificPrices: { cleaning: 2800, thermal: 3200, screen: 8000, ssd_upgrade: 3000, motherboard: 8000, reball_apu: 9000, replace_apu: 12000 } },
                    { id: 'steam_deck_oled', name: 'Steam Deck OLED 512GB/1TB', gen: 1.2, specificPrices: { cleaning: 3200, thermal: 3500, screen: 10000, ssd_upgrade: 3500, motherboard: 9000, reball_apu: 10000, replace_apu: 14000 } },
                ]
            },
    ...
    videocard: {
        ...
        brands: {
            nvidia_gtx_old: { multiplier: 0.8, name: 'NVIDIA GTX 10xx / 16xx', models: [{ id: 'gtx_1050', name: 'GTX 1050 / 1050 Ti', gen: 0.6 }, { id: 'gtx_1060', name: 'GTX 1060 (3/6 GB)', gen: 0.7 }, { id: 'gtx_1070', name: 'GTX 1070 / 1070 Ti', gen: 0.8 }, { id: 'gtx_1080', name: 'GTX 1080 / 1080 Ti', gen: 0.9, specificPrices: { reball: 5000, gpu_replace: 7000 } }, { id: 'gtx_1650', name: 'GTX 1650 / 1650 Super', gen: 0.7 }, { id: 'gtx_1660', name: 'GTX 1660 / 1660 Super / Ti', gen: 0.8 }] },
            nvidia_rtx_20: { multiplier: 1.0, name: 'NVIDIA RTX 20xx', models: [{ id: 'rtx_2060', name: 'RTX 2060 / 2060 Super', gen: 0.9 }, { id: 'rtx_2070', name: 'RTX 2070 / 2070 Super', gen: 1.0 }, { id: 'rtx_2080', name: 'RTX 2080 / 2080 Super', gen: 1.1, specificPrices: { reball: 6000, gpu_replace: 8500 } }, { id: 'rtx_2080ti', name: 'RTX 2080 Ti', gen: 1.3, specificPrices: { reball: 7500, gpu_replace: 10500, vram_replace: 6500 } }] },
            nvidia_rtx_30: { multiplier: 1.2, name: 'NVIDIA RTX 30xx', models: [{ id: 'rtx_3060', name: 'RTX 3060 / 3060 Ti', gen: 1.0 }, { id: 'rtx_3070', name: 'RTX 3070 / 3070 Ti', gen: 1.2, specificPrices: { reball: 6500, gpu_replace: 9500 } }, { id: 'rtx_3080', name: 'RTX 3080 / 3080 Ti', gen: 1.4, specificPrices: { reball: 8500, gpu_replace: 12500, vram_replace: 7000 } }, { id: 'rtx_3090', name: 'RTX 3090 / 3090 Ti', gen: 1.6, specificPrices: { reball: 10500, gpu_replace: 15500, vram_replace: 8500 } }] },
            nvidia_rtx_40: { multiplier: 1.5, name: 'NVIDIA RTX 40xx', models: [{ id: 'rtx_4060', name: 'RTX 4060 / 4060 Ti', gen: 1.2 }, { id: 'rtx_4070', name: 'RTX 4070 / 4070 Super / Ti', gen: 1.4, specificPrices: { reball: 9000, gpu_replace: 13500 } }, { id: 'rtx_4080', name: 'RTX 4080 / 4080 Super', gen: 1.6, specificPrices: { reball: 11000, gpu_replace: 17000, vram_replace: 9000 } }, { id: 'rtx_4090', name: 'RTX 4090', gen: 1.8, specificPrices: { reball: 14000, gpu_replace: 22000, vram_replace: 10500, cleaning: 4000 } }] },
            nvidia_rtx_50: { multiplier: 1.8, name: 'NVIDIA RTX 50xx (2025)', models: [{ id: 'rtx_5070', name: 'RTX 5070 / 5070 Ti', gen: 1.5, specificPrices: { reball: 10000, gpu_replace: 15000 } }, { id: 'rtx_5080', name: 'RTX 5080', gen: 1.7, specificPrices: { reball: 13000, gpu_replace: 20000, vram_replace: 11000 } }, { id: 'rtx_5090', name: 'RTX 5090', gen: 2.2, specificPrices: { reball: 18000, gpu_replace: 28000, vram_replace: 14000, cleaning: 5000 } }] },
            amd_rx_old: { multiplier: 0.9, name: 'AMD Radeon RX 5xx / Vega', models: [{ id: 'rx_580', name: 'RX 570 / 580 / 590', gen: 0.6, specificPrices: { reball: 4800 } }, { id: 'rx_vega', name: 'RX Vega 56 / 64', gen: 0.8, specificPrices: { reball: 5500, thermal: 3200 } }] },
            amd_rx_5000: { multiplier: 1.0, name: 'AMD Radeon RX 5xxx', models: [{ id: 'rx_5600', name: 'RX 5600 XT', gen: 0.9 }, { id: 'rx_5700', name: 'RX 5700 / 5700 XT', gen: 1.0, specificPrices: { reball: 6000 } }] },
            amd_rx_6000: { multiplier: 1.2, name: 'AMD Radeon RX 6xxx', models: [{ id: 'rx_6600', name: 'RX 6600 / 6600 XT', gen: 1.0 }, { id: 'rx_6700', name: 'RX 6700 XT', gen: 1.1 }, { id: 'rx_6800', name: 'RX 6800 / 6800 XT', gen: 1.3, specificPrices: { reball: 8000, gpu_replace: 11500 } }, { id: 'rx_6900', name: 'RX 6900 XT / 6950 XT', gen: 1.5, specificPrices: { reball: 10000, gpu_replace: 15000, vram_replace: 8000 } }] },
            amd_rx_7000: { multiplier: 1.4, name: 'AMD Radeon RX 7xxx', models: [{ id: 'rx_7600', name: 'RX 7600 / 7600 XT', gen: 1.2 }, { id: 'rx_7700', name: 'RX 7700 XT', gen: 1.3 }, { id: 'rx_7800', name: 'RX 7800 XT', gen: 1.4, specificPrices: { reball: 9500, gpu_replace: 14000 } }, { id: 'rx_7900', name: 'RX 7900 XT / XTX', gen: 1.7, specificPrices: { reball: 12500, gpu_replace: 19000, vram_replace: 9500 } }] },
            amd_rx_9000: { multiplier: 1.6, name: 'AMD Radeon RX 9000 (2025)', models: [{ id: 'rx_9070', name: 'RX 9070 / 9070 XT', gen: 1.5, specificPrices: { reball: 11000, gpu_replace: 16000 } }, { id: 'rx_9070_xtx', name: 'RX 9070 XTX', gen: 1.7, specificPrices: { reball: 13000, gpu_replace: 19000, vram_replace: 10000 } }] },
            intel_arc: { multiplier: 1.1, name: 'Intel Arc', models: [{ id: 'arc_a580', name: 'Arc A580', gen: 1.0 }, { id: 'arc_a750', name: 'Arc A750', gen: 1.1 }, { id: 'arc_a770', name: 'Arc A770', gen: 1.2 }, { id: 'arc_b580', name: 'Arc B580 (Battlemage 2024)', gen: 1.3 }, { id: 'arc_b770', name: 'Arc B770 (Battlemage 2025)', gen: 1.4, specificPrices: { reball: 8000 } }] },
...
export default function RepairCalculator({ initialDeviceType = null }) {
    ...
    const getFilteredServices = () => {
        ...
        return Object.entries(category.services).filter(([key, svc]) => {
            ...
            if (svc.requiresSeparateGlass) return modelData.hasSeparateGlass === true;
            if (svc.requiresThermalPads) return modelData.hasThermalPads === true;
            if (svc.requiresBga) return modelData.hasBga === true;
            if (svc.requiresTvType && Array.isArray(svc.requiresTvType)) {
                if (modelData.tvType) return svc.requiresTvType.includes(modelData.tvType);
                return true;
            }
            if (svc.requiresFaceId) return modelData.requiresFaceId !== false;
            if (key === 'liquid_metal') {
                return ['ps5_standard', 'ps5_digital', 'ps5_slim', 'ps5_pro', 'xbox_series_x', 'xbox_series_x_digital'].includes(modelData.id);
            }
            if (key === 'ssd_upgrade') {
                return ['ps5_standard', 'ps5_digital', 'ps5_slim', 'ps5_pro', 'xbox_series_s', 'xbox_series_x', 'xbox_series_x_digital', 'steam_deck_lcd', 'steam_deck_oled'].includes(modelData.id);
            }
            return true;
        });
    };
