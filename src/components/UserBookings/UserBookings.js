...
// Вычисляем текущие бронирования для отображения
...
const fetchUserBookings = async () => {
  try {
    ...
    if (response.ok) {
      ...
      // Проверяем, если ответ имеет поле data и это массив, то берем его, иначе берем весь результат, если он массив
      let bookingsArray = [];
