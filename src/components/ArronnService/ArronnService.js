            ...
            <div className={styles.arronServiceContent}>
                ...
                <div className={styles.arronServiceBrands}>
                    ...
                    <p className={styles.brandsSubtitle}>
                        ...
                        Так что если ваша техника дала сбой — не паникуйте! Доверьтесь профессионалам из сервисного центра "СЕРВИС БОКС" и наслаждайтесь дальше эксплуатацией
                        своих гаджетов!
                    </p>
