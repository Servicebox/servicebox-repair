...
export default function OrdersManagement() {
  ...
  // Безопасное получение email клиента
  ...
  // Безопасное получение телефона клиента
              ...
              <div className={styles.orderDetails}>
                <div className={styles.detailsGrid}>
                  <div className={styles.detailSection}>
                    ...
                    <p><strong>Имя:</strong> {getCustomerName(order)}</p>
                  ...
                  <div className={styles.detailSection}>
                    ...
                    <p><strong>Адрес:</strong> {order.shippingAddress?.address || 'Не указан'}</p>
                    <p><strong>Город:</strong> {order.shippingAddress?.city || 'Не указан'}</p>
                    <p><strong>Индекс:</strong> {order.shippingAddress?.postalCode || 'Не указан'}</p>
                  </div>
                      ...
                      <div key={index} className={styles.productItem}>
                        ...
                        <div className={styles.productInfo}>
                          ...
                          <div className={styles.productDetails}>
                            {product.quantity || 1} × {product.price || 0}₽ = {product.totalPrice || product.price || 0}₽
                          </div>
                          <div className={styles.productSlug}>
                            Артикул: {product.slug || product._id || 'Не указан'}
                          </div>
                        </div>
                      </div>
                    ))}
                ...
                <div className={styles.pricingSummary}>
                  <div className={styles.pricingRow}>
                    ...
                    <span>{order.pricing?.subtotal || order.subtotal || 0}₽</span>
                  </div>
                  <div className={styles.pricingRow}>
                    <span>Доставка:</span>
                  ...
                  <div className={`${styles.pricingRow} ${styles.total}`}>
                    <span>Итого:</span>
                    <span>{order.pricing?.totalAmount || order.totalAmount || 0}₽</span>
                  </div>
                </div>
