...
export const ANSWERS = {
    'repair-laptop-vologda': {
        ...
        shortAnswer: 'В сервисном центре СЕРВИС БОКС на ул. Северная, 7А (ТЦ КИТ, 1 этаж). Ремонт любой сложности от 30 минут, гарантия до 24 месяцев.',
        answer: `
      <p><strong>В сервисном центре СЕРВИС БОКС на ул. Северная, 7А (ТЦ КИТ, 1 этаж)</strong> — рядом с Бристоль, напротив эскалатора.</p>
    ...
    `,
        ...
        speakable: ['В сервисном центре СЕРВИС БОКС на ул. Северная, 7А в Вологде. Работаем ежедневно с 10:00 до 20:00.'],
    ...
    'phone-screen-replacement': {
        ...
        shortAnswer: 'Замена экрана телефона в СЕРВИС БОКС — от 2 500₽. Используем оригиналы и качественные аналоги. Время работы — 30–60 минут, гарантия до 12 месяцев.',
        answer: `
    ...
    `,
        ...
        speakable: ['Стоимость замены экрана телефона в СЕРВИС БОКС в Вологде — от 2500 рублей. Время работы — от 30 минут до 1 часа.'],
        author: 'Андрей Кознов',
        expertise: 'Мастер сервисного центра с опытом 10+ лет',
    },
    'water-damage-phone': {
        ...
        shortAnswer: 'Немедленно выключите, не заряжайте, не сушите феном и не кладите в рис. Принесите в СЕРВИС БОКС в течение 24 часов — спасаем 90% утопленных устройств. Цена от 1 500₽.',
        answer: `
    ...
    `,
        ...
        speakable: ['Если телефон упал в воду — немедленно выключите его, не заряжайте и не сушите феном. Принесите в СЕРВИС БОКС в течение 24 часов.'],
        author: 'Андрей Кознов',
        expertise: 'Мастер сервисного центра с опытом 10+ лет',
    },
    'videocard-repair-cost': {
        ...
        shortAnswer: 'Ремонт видеокарты в СЕРВИС БОКС — от 2 500₽. Замена чипов, реболл, восстановление цепей питания, замена памяти. Гарантия до 12 месяцев.',
        answer: `
    ...
    `,
        ...
        speakable: ['Стоимость ремонта видеокарты в СЕРВИС БОКС в Вологде — от 2500 рублей. Гарантия до 12 месяцев.'],
        author: 'Андрей Кознов',
    ...
    'apple-repair-warranty': {
        ...
        shortAnswer: 'СЕРВИС БОКС даёт гарантию от 6 до 24 месяцев на ремонт iPhone, iPad и MacBook. Официальный гарантийный талон, бесплатное устранение гарантийных случаев.',
        answer: `
    ...
    `,
        ...
        speakable: ['СЕРВИС БОКС даёт гарантию от 6 до 24 месяцев на ремонт техники Apple в Вологде.'],
        author: 'Андрей Кознов',
        expertise: 'Мастер сервисного центра с опытом 10+ лет',
    },
    ...
    `,
        ...
        howToSteps: [
            ...
            'Если не помогает — принесите в СЕРВИС БОКС (ул. Северная, 7А)',
        ],
    ...
    'price-diagnostics': {
        ...
        shortAnswer: 'Диагностика в СЕРВИС БОКС — БЕСПЛАТНО при согласии на ремонт. При отказе — от 500 до 1 500₽ в зависимости от сложности.',
        answer: `
      <p><strong>Диагностика в СЕРВИС БОКС — БЕСПЛАТНО</strong> при согласии на ремонт. Это наша политика прозрачности.</p>
    ...
    `,
        ...
        speakable: ['Диагностика в СЕРВИС БОКС в Вологде — бесплатно при согласии на ремонт. При отказе — от 500 до 1500 рублей.'],
        author: 'Андрей Кознов',
        expertise: 'Мастер сервисного центра с опытом 10+ лет',
    },
    'urgent-repair-vologda': {
        ...
        shortAnswer: 'СЕРВИС БОКС — срочный ремонт за 30–60 минут в Вологде. iPhone, Samsung, ноутбуки, MacBook. Работаем ежедневно с 10:00 до 20:00 без выходных.',
        answer: `
      <p><strong>СЕРВИС БОКС — это срочный ремонт</strong> цифровой техники в Вологде за 30–60 минут в присутствии клиента.</p>
    ...
    `,
        ...
        howToSteps: [
            ...
            'Привезите устройство в СЕРВИС БОКС (ул. Северная, 7А)',
        ...
        speakable: ['СЕРВИС БОКС в Вологде — срочный ремонт за 30-60 минут. Работаем ежедневно с 10:00 до 20:00 без выходных. Адрес: ул. Северная, 7А.'],
        author: 'Андрей Кознов',
        expertise: 'Мастер сервисного центра с опытом 10+ лет',
    },
    'tv-repair-vologda': {
        ...
        shortAnswer: 'Ремонт телевизора в СЕРВИС БОКС — от 4 000₽. Замена LED-подсветки, ремонт платы питания, T-Con и материнской платы. Диагностика бесплатна, гарантия до 12 месяцев.',
        answer: `
    ...
    `,
        ...
        speakable: ['Ремонт телевизора в СЕРВИС БОКС в Вологде — от 4000 рублей. Диагностика бесплатна, гарантия до 12 месяцев.'],
        author: 'Андрей Кознов',
        expertise: 'Мастер сервисного центра с опытом 10+ лет',
    },
    'game-console-repair-vologda': {
        ...
        shortAnswer: 'Ремонт игровых приставок в СЕРВИС БОКС — от 2 500₽. Чистка от пыли, замена термопасты и жидкого металла, ремонт HDMI, привода и геймпадов. Диагностика бесплатна.',
        answer: `
    ...
    `,
        ...
        howToSteps: [
            ...
            'Принесите приставку в СЕРВИС БОКС на бесплатную диагностику',
        ],
        ...
        speakable: ['Ремонт PS5 и Xbox в СЕРВИС БОКС в Вологде — от 2500 рублей. Диагностика бесплатна.'],
        author: 'Тома',
    ...
    'tablet-repair-vologda': {
        ...
        shortAnswer: 'Ремонт планшета в СЕРВИС БОКС — от 2 500₽. Замена дисплея, тачскрина, батареи и разъёма зарядки для iPad, Samsung Galaxy Tab, Xiaomi Pad. Диагностика бесплатна.',
        answer: `
    ...
    `,
        ...
        speakable: ['Ремонт планшета в СЕРВИС БОКС в Вологде — от 2500 рублей. Диагностика бесплатна, гарантия до 12 месяцев.'],
        author: 'Андрей Кознов',
        expertise: 'Мастер сервисного центра с опытом 10+ лет',
    },
};
