...
export const BUSINESS = {
    name: 'СЕРВИС БОКС - Сервисный центр на Северной',
    shortName: 'СЕРВИС БОКС Вологда',
...
export const SEO_DEFAULTS = {
    ...
    keywords: 'ремонт ноутбуков Вологда, ремонт телефонов, сервисный центр, ремонт видеокарт, ремонт техники, ремонт Apple, чистка ноутбуков, переклейка стекол, СЕРВИС БОКС, Северная 7А',
};