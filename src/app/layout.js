  ...
  return (
    ...
    try {
      ...
      if (hc === 'true') document.documentElement.setAttribute('data-contrast', 'high');
        ...
        <meta charSet="utf-8" />
        {/* Google Tag Manager загружается не здесь, а из
            components/Analytics/Analytics.js — только после согласия на
            аналитические cookie (он же грузит Яндекс.Метрику). */}
