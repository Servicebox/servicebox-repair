      ...
      <div className={styles.formSection}>
        ...
        <form className={styles.createForm} onSubmit={handleNewSubmit}>
          <div className={styles.formGrid}>
            ...
            <div className={styles.formGroup}>
              <label className={styles.formLabel}>Производитель (Vendor)</label>
              <input
                name="vendor"
                placeholder="Официальное название производителя"
            ...
            <div className={styles.formGroup}>
              <label className={styles.formLabel}>Артикул производителя</label>
              <input
                name="vendorCode"
                placeholder="Оригинальный артикул товара"
            ...
            <div className={styles.formGroup}>
              <label className={styles.formLabel}>GTIN (EAN/UPC код)</label>
              <input
                name="gtin"
                placeholder="Международный код товара"
            ...
            <div className={styles.formGroup}>
              <label className={styles.formLabel}>Страна производства</label>
              <input
                name="country"
                placeholder="Россия"
                value={newProduct.country || "Россия"}
                onChange={handleNewChange}
                className={styles.formInput}
              />
            </div>
            ...
            <div className={styles.formGroup}>
              ...
              <input
                ...
                className={styles.formInput}
              />
              <p className={styles.helpText}>Минимум 1 для экспорта в Яндекс.Маркет</p>
            </div>
            ...
            <div className={styles.formGroup}>
              <label className={styles.formLabel}>Длина (см) *</label>
              <input
                ...
                min="0"
                placeholder="20"
                value={newProduct.dimensions?.length || 20}
                onChange={handleNewChange}
                className={styles.formInput}
                required
              />
            ...
            <div className={styles.formGroup}>
              <label className={styles.formLabel}>Ширина (см) *</label>
              <input
                ...
                min="0"
                placeholder="20"
                value={newProduct.dimensions?.width || 20}
                onChange={handleNewChange}
                className={styles.formInput}
                required
              />
            ...
            <div className={styles.formGroup}>
              <label className={styles.formLabel}>Высота (см) *</label>
              <input
                ...
                min="0"
                placeholder="10"
                value={newProduct.dimensions?.height || 10}
                onChange={handleNewChange}
                className={styles.formInput}
                required
              />
