      ...
      <div className={styles.content}>
        <header className={styles.header}>
          ...
          <div className={styles.meta}>
            <p>ООО «СЕРВИС БОКС»</p>
            <p>Дата последнего обновления: сентябрь 2026 г.</p>
          </div>
        </header>
        ...
        <section className={styles.section}>
            ...
            <table style={{
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td style={tdStyle}><code>_ym_uid</code>, <code>_ym_d</code>, <code>_ym_isad</code>, <code>_ym_visorc</code> и др. (Яндекс.Метрика)</td>
                  <td style={tdStyle}>Анализ посещаемости, источников трафика, карта кликов, Вебвизор. Подключаются только с вашего согласия.</td>
                  <td style={tdStyle}>Сессия — до 1 года</td>
                </tr>
              </tbody>
            </table>
          </div>
          ...
          <div style={{ marginTop: '1rem' }}>
            <div className={styles.companyInfo} style={{ borderLeftColor: '#22c55e' }}>
              <h3>Обезличенный счётчик посещений (без cookie)</h3>
              <p style={{ margin: '0.5rem 0 0', color: '#6b7280', fontSize: '0.9rem' }}>
                Для базовой статистики посещаемости сайт использует собственный
                счётчик, который не устанавливает cookie и не передаёт данные
                третьим лицам. В браузере хранится только случайный
                идентификатор (<code>sb_vid</code> в localStorage) для примерной
                оценки числа уникальных посетителей; на сервере сохраняются
                исключительно агрегированные показатели (страница, тип
                устройства, браузер, дата) без сведений, позволяющих вас
                идентифицировать.
              </p>
            </div>
          </div>
          ...
          <div style={{ marginTop: '1.5rem' }}>
            <div className={styles.companyInfo}>
              ...
              <p style={{ margin: '0.75rem 0 0', color: '#6b7280', fontSize: '0.9rem' }}>
                Виджет онлайн-чата поддержки хранит в браузере локальный
                идентификатор диалога, чтобы переписка не терялась между
                страницами. Он относится к функциональным и не используется
          ...
          <div style={{ marginTop: '1rem' }}>
            <div className={styles.companyInfo} style={{ borderLeftColor: '#0ea5e9' }}>
              <h3>Аналитические файлы cookie (Яндекс.Метрика)</h3>
              <p style={{ margin: '0.5rem 0 0', color: '#6b7280', fontSize: '0.9rem' }}>
                Сайт использует Яндекс.Метрику (оператор — ООО «ЯНДЕКС») для
                анализа посещаемости, источников трафика, карты кликов и записи
                действий пользователя (Вебвизор). Метрика устанавливает
                собственные cookie <code>_ym_*</code>. Эти cookie{' '}
                <strong>не загружаются по умолчанию</strong> — они подключаются
                только после того, как вы нажали «Принять все» или включили
                категорию «Аналитические» в баннере согласия. Отозвать согласие
                можно там же (кнопка «Только необходимые»); при этом cookie
                Метрики удаляются.
              </p>
              <p style={{ margin: '0.75rem 0 0', color: '#6b7280', fontSize: '0.9rem' }}>
                Для управления аналитическими тегами используется контейнер
                Google Tag Manager. Сам по себе он не собирает персональные
                данные и не устанавливает рекламных cookie; он лишь загружает
                перечисленные выше аналитические инструменты — с учётом вашего
                выбора в баннере.
              </p>
            </div>
          </div>
