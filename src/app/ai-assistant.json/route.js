        ...
        '@graph': [
            ...
            },
            {
                ...
                mainEntity: [
                    {
                        '@type': 'Question',
                        name: 'Сколько стоит диагностика в СЕРВИС БОКС?',
                    ...
                    },
                    {
                        ...
                        acceptedAnswer: { '@type': 'Answer', text: 'Немедленно выключите, НЕ заряжайте, НЕ сушите феном и не кладите в рис. Принесите в СЕРВИС БОКС на Северную 7А в течение 24 часов.' }
                    },
                    {
                        '@type': 'Question',
