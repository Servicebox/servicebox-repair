...
const About = forwardRef((_props, ref) => {
  ...
  const photoAlts = [
    "Ремонт ноутбуков, компьютеров, техники Apple в Вологде - СЕРВИС БОКС",
    "Ремонт iPhone, iPad, MacBook в Вологде - СЕРВИС БОКС",
    "Качественный ремонт ноутбуков в Вологде - СЕРВИС БОКС",
    "Ремонт игровых приставок Sony, Xbox в Вологде - СЕРВИС БОКС",
    "Ремонт телефонов, планшетов в Вологде - СЕРВИС БОКС",
    "Профессиональный ремонт техники в Вологде - СЕРВИС БОКС",
    "Срочный ремонт электроники в Вологде - СЕРВИС БОКС",
    "Ремонт видеокарт, материнских плат в Вологде - СЕРВИС БОКС"
  ];
    ...
    <section id="aboutRef" className={styles.container} ref={ref}>
      <div className={styles.content}>
        ...
        <h3 className={styles.heading}>
          Предлагаем быстрый и профессиональный ремонт видеокарт, ноутбуков, материнских плат, ПК, игровых консолей Sony, X-box, техники Apple, телефонов, планшетов, телевизоров.
        </h3>
